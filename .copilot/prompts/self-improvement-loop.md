...
- Example usage
  - “Use this template. My task is: add a new CLI command that writes to System/Active. I’m using OpenAI. Ensure agents/ has sufficient guidance; if not, patch it (minimal) and rebuild/validate before coding.”
